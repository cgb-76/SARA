...
Plans:
- [x] 13-01-PLAN.md — Rewrite sara-lint/SKILL.md v2.0: five mechanical checks (D-02 missing frontmatter, D-03 broken related[], D-04 orphaned pages, D-05 index sync, D-06 Cross Links sync), per-finding approval loop, atomic per-fix commits
- [x] 13-02-PLAN.md — End-to-end verification: prepare test wiki with known gaps, run /sara-lint, human checkpoint
